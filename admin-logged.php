...
<body>
    ...
    <div class="main-container">
        <p class="big-white-text">Admin Scoresheet</p>
        <div class="item_container">
            <form class="table_container" method="POST">
                  <table border="0">
                        <tr class="table_header" style="text-align: left; ">
                            <th style="padding-bottom:10px">Usercode</th>
                            <th style="padding-bottom:10px">Score</th>
                            <th style="padding-bottom:10px">Average</th>
                            <th style="padding-bottom:10px">Truncate</th>
                        </tr>
                        <?php
